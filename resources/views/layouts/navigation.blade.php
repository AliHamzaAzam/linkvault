<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <a href="/login" class="text-sm text-gray-500 hover:text-gray-700">Log in</a>
                    <a href="/register" class="ml-4 text-sm text-gray-500 hover:text-gray-700">Register</a>
                </div>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('bookmarks.search')" :active="request()->routeIs('bookmarks.search')">
                Search
            </x-responsive-nav-link>
